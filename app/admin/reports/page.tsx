      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-title-1 gradient-text">Team-Berichte</h1>
        ...
        >
          ...
          <div className="relative z-10 text-center py-16">
            ...
            <p className="text-text-secondary max-w-md mx-auto">
              Diese Funktion wird in Kürze verfügbar sein. Hier können Sie Team-Berichte
              und Auswertungen erstellen und exportieren.
            </p>
          </div>
        </motion.div>
      </div>
