      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex gap-6">
            {/* Home Link (zurück zum Hauptmenü) */}
            <motion.div
              whileHover={{ y: -2 }}
            ...
            >
              ...
              >
                <span className="group-hover:text-novu-400 transition-colors text-body">Home</span>
            ...
            {/* Dashboard (Aktiver Tab - Zeiterfassung) */}
            <motion.div
              whileHover={{ y: -2 }}
              transition={{ duration: 0.2 }}
            >
            ...
            {['Zeiteinträge', 'Berichte'].map((item) => (
              <motion.div
                key={item}
                whileHover={{ y: -2 }}
                transition={{ duration: 0.2 }}
